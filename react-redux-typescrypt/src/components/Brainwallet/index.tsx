    ...
    function openBrainWallet() {
        ...
        my_nano_js_open_brainwallet(braiwallet_value, salt_value).then(
            (result) => {
                ...
                my_nano_js_seed2keypair(0, (result as BRAINWALLET_RESPONSE).extracted.result.seed).then(
                    (seed2keypair: any) => {
                        ...
                        my_nano_js_seed_to_encrypted_stream((result as BRAINWALLET_RESPONSE).extracted.result.seed as string, token).then(
