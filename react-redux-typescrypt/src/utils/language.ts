...
export const LANG_PT_BR = {
    ...
    welcome_msg: "Nano Electron. Uma tecnologia binding em C que integra Nano ao NodeJS",
...
export const LANG_EN_US = {
    ...
    welcome_msg: "Nano Electron. A C binding technology that integrates Nano to NodeJS",
