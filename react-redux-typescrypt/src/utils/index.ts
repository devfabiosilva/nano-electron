...
export const MY_NANO_JS_VERIFY_SIG_HASH = "hash";
...
export const NANO_JS_COMMANDS = {
    ...
    COMMAND_SEND_RECEIVE_P2POW: 21
}

export const BIG_NUMBER_TYPE_USER_AMOUNT_REAL = 1;
export const BIG_NUMBER_TYPE_USER_AMOUNT_RAW = 2;
export const BIG_NUMBER_TYPE_USER_AMOUNT_HEX = 4;
export const BIG_NUMBER_TYPE_VALUE_TO_SEND_RECEIVE_REAL = 8;
export const BIG_NUMBER_TYPE_VALUE_TO_SEND_RECEIVE_RAW = 16;
export const BIG_NUMBER_TYPE_VALUE_TO_SEND_RECEIVE_HEX = 32;
export const BIG_NUMBER_TYPE_WORKER_FEE_REAL = 64;
export const BIG_NUMBER_TYPE_WORKER_FEE_RAW = 128;
export const BIG_NUMBER_TYPE_WORKER_FEE_HEX = 256;
export const BIG_NUMBER_TYPE_USER_FEE_REAL = 512;
export const BIG_NUMBER_TYPE_USER_FEE_RAW = 1024;
export const BIG_NUMBER_TYPE_USER_FEE_HEX = 2048;
export const BIG_NUMBER_TYPE_MAX_FEE_REAL = 4096;
export const BIG_NUMBER_TYPE_MAX_FEE_RAW = 8192;
export const BIG_NUMBER_TYPE_MAX_FEE_HEX = 16384;
